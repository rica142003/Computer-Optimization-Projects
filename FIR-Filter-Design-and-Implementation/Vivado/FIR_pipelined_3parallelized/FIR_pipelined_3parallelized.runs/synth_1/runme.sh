...
HD_PWD='C:/Users/chacr/OneDrive/Documents/Advanced VLSI/GIT/FIR_pipelined_3parallelized/FIR_pipelined_3parallelized.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filter_3path_parallel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_filter_3path_parallel.tcl
