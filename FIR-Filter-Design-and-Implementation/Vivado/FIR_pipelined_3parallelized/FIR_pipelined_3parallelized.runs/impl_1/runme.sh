...
HD_PWD='C:/Users/chacr/OneDrive/Documents/Advanced VLSI/GIT/FIR_pipelined_3parallelized/FIR_pipelined_3parallelized.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filter_3path_parallel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_filter_3path_parallel.tcl -notrace
